        ...
        <section class="bg-white">
            <div class="container py-2 h-100">
                <div class="row d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-md-6">
                        <img src='<c:url value="https://img.freepik.com/free-vector/login-concept-illustration_114360-739.jpg" />'
                            ...
                            <div class="card-body p-md-5 p-sm-2">
                                <form action="/security/login" method="post">
                                    ...
                                    <div class="form-check d-flex justify-content-start mb-4">
                                        ...
                                        <a href="/security/forgot-password" class="ms-auto text-decoration-none">Forgot
                                            password?</a>
                                    </div>
                                    <div class="d-grid gap-2 mb-2">
                                        <button type="submit" id="submit" class="btn btn-lg rounded-3 btn-primary">Sign
                                            In
                                        </button>
                                    </div>
                                    <hr class="my-4">
